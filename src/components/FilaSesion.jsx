    ...
    <div className='fil-sesion mb-3'>
      <div className='row-sesion shadow'>
        ...
        <div className='d-flex'>
          <div className='info'>
            <span>{session.paciente.nombre}</span> {/* Ejemplo de acceso a propiedad simple */}
            <br />
        ...
        <div className='d-flex'>
          <div className='info'>
            Hora
            <br />
            <span>{session.horaInicio}</span> {/* Ejemplo de acceso a propiedad simple */}
          </div>
        </div>
        ...
        <div className='d-flex'>
          <div className='info'>
            ...
            <span className='state-inf'>
              {colorEstado(session.estado.nombreEstado)} {/* Ejemplo de acceso a propiedad simple */}
            </span>
          </div>
        </div>
        ...
        <div className='d-flex'>
          <div className='info'>
            ...
            <span>
              ...
              {showModalInf && (
                <ModalInforme onClose={handleCloseModalInf} session={session} onSave={handleSaveInforme} />
              )}
              ...
              />
              <MostrarInforme show={showModal} handleClose={handleCloseModal} session={session} informe={informe} />
              ...
              {informe === '' ? (
                ...
                <DescargarInforme className="inline-component" session={session} informe={informe} />
              )}
            </span>
          </div>
        </div>
